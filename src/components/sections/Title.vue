...
// logo地址，没有则置为""即可
const logo = '/Dolphin/icon.png'

// 标题
const title = 'Efficient Audio-Visual Speech Separation with Discrete Lip Semantics and Multi-Scale Global-Local Attention'
...
const addresses = [
  {
    ...
    homepage: "https://www.tsinghua.edu.cn/"
  },
]
...
// 最新消息
const news = "🔥 [2025-09-16] Code and pre-trained models will be released! 📦"

// 强调内容
const emphases = [
  "🥂 Cocktail-Party Robustness: Visual cues reinforce separation when noise overwhelms audio-only systems",
  "🎬 DP-LipCoder: Dual-path VQ encoder distilled from AV-HuBERT to produce audio-aligned lip tokens",
  "🌐 Global–Local Attention: Single-pass separator merges coarse self-attention with heat diffusion smoothing",
  "⚡ Edge-Ready Efficiency: Over 50% fewer parameters, 2.4× lower MACs, and 6× faster GPU inference than IIANet"
]
...
const buttons = [
  ...
  },
  {
    disabled: false,
    name: "🎵 Demo",
    link: "https://cslikai.cn/Dolphin",
    component: MagicStick,
  },
  {
    disabled: false,
    name: "💻 Code",
    link: "https://github.com/JusperLee/Dolphin",
    component: Files,
  },
  {
    disabled: false,
    name: "🤗 Model",
    link: "https://huggingface.co/JusperLee/Dolphin",
    component: DataAnalysis,
  },
  {
    disabled: false,
    name: "👾 Gradio Demo",
    link: "https://dolphin.cslikai.cn/",
    component: Film,
  },
]
...
<template>
  <div>
    ...
    <el-row justify="center">
      <el-col :span="24">
        <el-alert title="🔥 [2025-10-01] Code and pre-trained models will be released! 📦" type="success" />
      </el-col>
    </el-row>
